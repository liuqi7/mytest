...
<tr>
	<td><input type="checkbox" name="items[${s.index }].id" value="${item.id }" /> </td>
	...
	<td><input name="items[${s.index}].createtime" value="<fmt:formatDate value="${item.createtime}" pattern="yyyy-MM-dd HH:mm:ss"/>"></td>
